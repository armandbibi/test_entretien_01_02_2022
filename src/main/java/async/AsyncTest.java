...
class AsyncTest {
  ...
  public static CompletableFuture<Option<Ceo>> getCeoById(String ceo_id) {
   ...
   return CompletableFuture.supplyAsync(() -> ceos.find(ceo -> ceo.id == ceo_id));
  }

  public static CompletableFuture<Option<Enterprise>> getEnterpriseByCeoId(String ceo_id) {
    
    return CompletableFuture.supplyAsync(() -> enterprises.find(enterprise -> enterprise.ceo_id == ceo_id));
  }
  ...
  public static CompletableFuture<Tuple2<Option<Ceo>, Option<Enterprise>>> getCEOAndEnterprise(String ceo_id) {
    ...
    return ceo.thenCombine(enterprise, (s1, s2) -> Tuple.of(s1, s2));
  }
